...
Bedrocked is an open-source Minecraft Java mod focused on bringing the Bedrock Edition experience to Java — in a modern, accessible and community-driven way.

The goal is to make modded Minecraft easier for beginners while still offering powerful customization for advanced players.
